...
def testpagar():
	...
	assert round(card.saldo())==round(94.25,2)
	assert round(card2.saldo())==round(97.1,2)
	card.pagar(bondi2,"12/12/1998 8:40")
	card2.pagar(bondi2,"12/12/1998 8:40")
	assert round(card.saldo())==round(92.35,2)
	assert round(card2.saldo())==round(96.14,2)
	card2.pagar(bondi2,"13/12/1998 2:40")
	assert round(card2.saldo())==round(90.39,2)
